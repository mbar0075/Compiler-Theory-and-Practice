...
1. [Compiler Theory](https://github.com/mbar0075/Compiler-Theory-and-Practice/tree/main/Compiler%20Theory) - Directory which holds implementation of the PixArDis Compiler.
2. [Report Diagrams](https://github.com/mbar0075/Compiler-Theory-and-Practice/tree/main/Report%20Diagrams) - Directory which holds the diagrams constructed through draw.io, to be used in the report.
3. [Sample Programs](https://github.com/mbar0075/Compiler-Theory-and-Practice/tree/main/Sample%20Programs) - Directory which holds the sample PixArLang programs, which can be fed to the constructed PixArDis Compiler.
4. [VM Box Used to Run Generated Code](https://github.com/mbar0075/Compiler-Theory-and-Practice/tree/main/VM%20Box%20Used%20to%20Run%20Generated%20Code) - Directory which holds the Virtual Machine utilised to run the PixIR code generated from the Compiler.
5. [Video](https://github.com/mbar0075/Compiler-Theory-and-Practice/tree/main/Video) - Directory which holds the video demonstration of the constructed Compiler.
6. [report.pdf](https://github.com/mbar0075/Compiler-Theory-and-Practice/blob/main/report.pdf) - Documentation for the PixArDis Compiler.
